...
def dist_cost_dict():
    ...
    for node in neighbour_dict:
        ...
        for neighbour in neighbour_dict[node]:
            ...
            neighbour_weight_dict[neighbour] = weight, cost
        
        # Adds the neighbour-weight pair to nested dictionary weighted_cost_dict
        weighted_cost_dict[node] = neighbour_weight_dict

    return weighted_cost_dict
